...
let animations = {
  // 靜止狀態
  stop: { img: null, srcCandidates: ['stop/0.png'], frameWidth: 46, frameHeight: 47, totalFrames: 1, frameDelay: 8 },
  // 四個移動方向的動畫
  goUp: { img: null, srcCandidates: ['go/all.png'], frameWidth: 51.33, frameHeight: 51, totalFrames: 3, frameDelay: 6 },
  goDown: { img: null, srcCandidates: ['go/all.png'], frameWidth: 51.33, frameHeight: 51, totalFrames: 3, frameDelay: 6 },
  goLeft: { img: null, srcCandidates: ['go/all.png'], frameWidth: 51.33, frameHeight: 51, totalFrames: 3, frameDelay: 6 },
  goRight: { img: null, srcCandidates: ['go/all.png'], frameWidth: 51.33, frameHeight: 51, totalFrames: 3, frameDelay: 6 },
  // 特殊動作
  punch: { img: null, srcCandidates: ['打/all.png'], frameWidth: 60, frameHeight: 60, totalFrames: 13, frameDelay: 5 } // one-shot animation
};
